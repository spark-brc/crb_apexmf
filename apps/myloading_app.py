    ...
    def run(self,app_target):
        ...
        try:
            ...
            if app_title == 'Sequency Denoising':
                ...
                with HyLoader("✨Now loading {}".format(app_title), loader_name=self._loader, index=3):
                # with HyLoader("✨Now loading {}".format(app_title), loader_name=Loaders.showcase_pretty):
                    time.sleep(int(self.delay))
                    app_target.run()
